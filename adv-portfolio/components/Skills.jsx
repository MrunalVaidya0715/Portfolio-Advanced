...
function Skills() {
  return (
    ...
    <div id='skills' className=' z-[90] max-w-[1240px] w-full md:h-screen m-auto p-4 relative top-0 left-0 overflow-hidden  '>
      ...
      <div className=' relative flex justify-center w-full h-full flex-col'>
        ...
        <div className='grid grid-cols-2  md:grid-cols-3 lg:grid-cols-4  gap-8 py-[20px] '>
          <div className='flex items-center justify-around bg-[#15181E]/80 backdrop-blur-md hover:bg-[#252a34] border-[1px] border-gray-500 shadow-md hover:shadow-2xl rounded-lg p-[35px] ease-in duration-200'>
          ...
          <div className='flex items-center justify-around bg-[#15181E]/80 backdrop-blur-md  hover:bg-[#252a34] border-[1px] border-gray-500 shadow-md hover:shadow-2xl rounded-lg p-[5rem] ease-in duration-200'>
