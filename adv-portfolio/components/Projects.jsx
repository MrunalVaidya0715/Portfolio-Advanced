...
function Projects() {
    return (
        <div id='projects' className=' relative top-[16rem] flex w-full h-auto md:h-screen  items-center justify-center p-4 my-16'>
                ...
                <div className=' flex max-w-[1240px] w-full h-full py-20 '>
                    <div className=' w-full h-full flex  items-center justify-center'>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4  '>
                            ...
                            <div className='relative flex items-center justify-center p-0 h-auto  w-full  border-[1px] border-gray-500 bg-gray-900/90 backdrop-blur-sm shadow-gray-900 rounded-2xl  group  hover:bg-gray-900/90 ' >
                                <img className=' rounded-2xl group-hover:duration-300 group-hover:opacity-10 group-hover:blur-[2px] ' src='assets/projects/crypto.jpg' alt='/' />
                                <div className='hidden z-[1000] group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] duration-700 translate-y-[-50%]'>{/*Overlay */}
