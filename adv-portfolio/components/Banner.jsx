    ...
    return (
        <div className='w-full h-screen mt-[5rem]'>
            <div className='flex flex-col items-center w-full  max-w-[1240px]  mx-auto p-4 justify-center '>
                <div className=' bg-blend-difference   relative  rounded-lg  w-full h-[40vh] md:h-[50vh] min-w-[40vh] bg-[#20202a] opacity-100 bg-right-top bg-cover bg-no-repeat ease-in duration-500' style={{ backgroundImage: "url('/assets/mum1.jpg')" }}>
