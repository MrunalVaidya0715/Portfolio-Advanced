    ...
    return (
        <div className='w-full h-screen mt-[5rem]'>
            <div className='flex flex-col items-center w-full  max-w-[1240px]  mx-auto p-4 justify-center '>
                <div className=' bg-blend-difference   relative  rounded-lg  w-full h-[30vh] md:h-[50vh] min-w-[40vh] bg-[#20202a] opacity-100 bg-right-top bg-cover bg-no-repeat' style={{ backgroundImage: "url('/assets/mum1.jpg')" }}>
                ...
                <div className='z-[2] grid grid-cols-2 lg:grid-cols-4  gap-4 py-[20px] w-full '>
                    <div className='flex items-center border-[1px] border-gray-500 hover:bg-[#252a34] justify-around  bg-[#15181E] shadow-md hover:shadow-lg hover:shadow-gray-900 hover:translate-y-[-0.2rem] rounded-lg p-[35px] ease-in duration-200'>
                        <div>
